package com.aoying.loan.common.util.encode;

import java.util.List;

public class Encode {
	public static void main(String[] args) {
		System.out.println(encodeTelNo("18621599019"));
		System.out.println(encodeIdCardNo("420103198905085715"));
		System.out.println(encodeName("李曾天"));
	}
	...
	public static String encodeTelNo(String telNo, boolean isEncode) {
		if (Encode.isEmpty(telNo) || !DataCheck.isPhoneNumber(telNo)) {
			return telNo;
		}
	...
	public static String encodeIdCardNo(String idCardNo, boolean isEncode) {
		if (Encode.isEmpty(idCardNo) || !DataCheck.checkIdCardNo(idCardNo)) {
			return idCardNo;
		}
	...
	public static String encodeBankCardNo(String bankCardNo, boolean isEncode) {
		if (Encode.isEmpty(bankCardNo) || !DataCheck.checkBankCardNo(bankCardNo)) {
			return bankCardNo;
		}
