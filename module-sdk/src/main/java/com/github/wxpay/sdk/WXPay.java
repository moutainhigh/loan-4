...
public class WXPay {
    ...
    public Map<String, String> fillRequestDataForJs(String prepayId) throws Exception {
        Map<String, String> reqData = new HashMap<String, String>();
        reqData.put("appId", config.getAppID());
        reqData.put("timeStamp", Long.toString(System.currentTimeMillis()));
    ...
    public boolean fillRequestDataForSign(Map<String, String> reqData) throws Exception {
        String sign = reqData.get("sign");
        reqData.remove("sign");

        WXPayConstants.SignType signType;
        if (WXPayConstants.MD5.equals(reqData.get("sign_type"))) {
            signType = WXPayConstants.SignType.MD5;
        } else {
            signType = WXPayConstants.SignType.HMACSHA256;
        }

        String localSign = WXPayUtil.generateSignature(reqData, config.getKey(), signType);
    ...
    public String getCodeToOpenidUrl(String code) {
        StringBuilder url = new StringBuilder();
        url.append("https://api.weixin.qq.com/sns/oauth2/access_token")
                .append("?appid=").append(this.config.getAppID())
                .append("&secret=").append(this.config.getKey())
