...
import com.xinyan.api.util.FormatUtil;
...
public final class RsaCodingUtil {
	 ...
	 * @return
	 */
	public static String encryptByPriPfxFile(String src, InputStream priKeyStream, String priKeyPass) {
